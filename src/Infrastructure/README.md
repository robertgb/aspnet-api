...
O `AppDbContext` e os repositórios `EfCustomerRepository` e `EfProductRepository` implementam a persistência PostgreSQL. Esta camada é a única que conhece EF Core e Npgsql; Domain e Application dependem apenas de contratos.
